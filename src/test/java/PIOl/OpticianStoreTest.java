...
public class OpticianStoreTest {
    ...
    public void singletonTestName() {
        OpticiansStore optyk = OpticiansStore.getInstance();
        OpticiansStore optykSecondInstance = OpticiansStore.getInstance();

        optyk.setName("Idea-optyk");

        Assert.assertEquals(optyk.getName(), "Idea-optyk");
        Assert.assertEquals(optyk.getName(), optykSecondInstance.getName());
    }
    ...
    public void addClients() {
        ...
        Client client = new Client("Jan", "Kowalski", LocalDate.of(1995, 1
                , 10), BigInteger.valueOf(95011023522L));
    ...
    public void addEmployee(){
        ...
        Assert.assertEquals(OpticiansStore.getCustomerServiceEmployees().get(OpticiansStore.getCustomerServiceEmployees().size()-1),employee);
    }
