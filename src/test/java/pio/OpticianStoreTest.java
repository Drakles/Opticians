...
public class OpticianStoreTest {
  ...
  public void addClients() {
    ...
    Assert.assertEquals(OpticiansStore.getClients().get(OpticiansStore.getClients().size() - 1),
        client);
  }
  ...
  public void addEmployee() {
    ...
    Assert.assertTrue(
        OpticiansStore.getCustomerServiceEmployees().size() - 1 == actualNumberEmployee);
  ...
  public void addDoctor() {
    ...
    Assert.assertEquals(OpticiansStore.getDoctors().get(OpticiansStore.getDoctors().size() - 1),
        doctor);
  }
