...
public class ScheduleTest {
  ...
  public void getWorkDay() {
    ...
    schedule.getWorkDays()
        .add(new WorkDay(LocalDateTime.of(2018, 6, 18, 10, 0), LocalDateTime.of(2018, 6, 18,
            18, 0)));
    WorkDay workDayFound = schedule.getWorkDay(LocalDate.of(2018, 6, 18));
    Assert
        .assertEquals(workDayFound, schedule.getWorkDays().get(schedule.getWorkDays().size() - 1));
